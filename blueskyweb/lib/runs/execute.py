...
class BlueSkyRunExecutor(object):
    ...
    async def _configure_visualization(self, data):
        ...
        bkml_con["RainbowColorBarVisualRange"] = {
            "DEFINE_RGB": "true",
            "DATA_LEVELS": "0 0.035 0.076 0.150 0.25  0.5 1 2 3 4 5 10 20 100",
            "RED": "43 114 199 255 255 255 154 0 13 0 153 204 0",
            "GREEN": "10 39 21 0 102  255 205 255 152 0 204 229 0",
            "BlUE": "120 137 133 0 0 0 50 0 186 255 255 255 0",
            "IMAGE_OPACITY_FACTOR": "0.7"
        }
