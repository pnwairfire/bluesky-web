...
curl "$BLUESKY_API_ROOT_URL/api/v1/run/all/DRI4km/?_m=fuelbeds" -H 'Content-Type: application/json' -d ' { "fire_information": []}' |python -m json.tool
curl "$BLUESKY_API_ROOT_URL/api/v1/run/dispersion/DRI4km/?_m=fuelbeds" -H 'Content-Type: application/json' -d ' { "fire_information": []}' |python -m json.tool
...
curl "$BLUESKY_API_ROOT_URL/api/v1/run/all/DRI4km/?_m=fuelbeds" -H 'Content-Type: application/json' -d ' { "fire_information": [], "modules":["emissions", "dispersion"]}' |python -m json.tool
curl "$BLUESKY_API_ROOT_URL/api/v1/run/dispersion/DRI4km/?_m=fuelbeds" -H 'Content-Type: application/json' -d ' { "fire_information": [], "modules":["dispersion"]}' |python -m json.tool
...
curl -D - "$BLUESKY_API_ROOT_URL/api/v1/run/all/DRI4km/?_m=fuelbeds" -H 'Content-Type: application/json' -d ' { "fire_information": [], "modules":["sdf"]}'
curl -D - "$BLUESKY_API_ROOT_URL/api/v1/run/dispersion/DRI4km/?_m=fuelbeds" -H 'Content-Type: application/json' -d ' { "fire_information": [], "modules":["fuelbeds"]}'


# some other requests
curl -D - "$BLUESKY_API_ROOT_URL/api/v1/run/dispersion/DRI4km/?_m=fuelbeds" -H 'Content-Type: application/json' -d ' { "fire_information": [], "modules":["timeprofiling"]}'
curl -D - "$BLUESKY_API_ROOT_URL/api/v1/run/dispersion/DRI4km/?_m=fuelbeds" -H 'Content-Type: application/json' -d ' { "fire_information": [], "modules":["consumption", "sdfsdf", "timeprofiling"]}'
